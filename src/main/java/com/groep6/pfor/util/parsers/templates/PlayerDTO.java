...
public class PlayerDTO {
    ...
    public static PlayerDTO fromModel(Player player) {
        return new PlayerDTO(player.getUsername(), player.isCurrentTurn(), player.getCityPlayerIsCurrentlyLocatedIn().getName(), player.getRoleCard().getEventName(), player.getActionsRemaining());
    }
